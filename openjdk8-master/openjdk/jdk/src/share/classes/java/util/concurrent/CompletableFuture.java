 ...
 * {@link #cancel cancel}
 * a CompletableFutureTest, only one of them succeeds.
 *
 * <p>In addition to these and related methods for directly
 * manipulating status and results, CompletableFutureTest implements
 * interface {@link CompletionStage} with the following policies: <ul>
 *
 * <li>Actions supplied for dependent completions of
 * <em>non-async</em> methods may be performed by the thread that
 * completes the current CompletableFutureTest, or by any other caller of
 ...
 *
 * <p>CompletableFutureTest also implements {@link Future} with the following
 * policies: <ul>
 *
 ...
 * CompletableFutureTest completed in any exceptional fashion.</li>
 *
...
public class CompletableFuture<T> implements Future<T>, CompletionStage<T> {
    ...
    // version of ThenCopy for CompletableFutureTest<Void> dst
    ...
    /**
     * Creates a new incomplete CompletableFutureTest.
     */
    public CompletableFuture() {
    }

    /**
     * Returns a new CompletableFutureTest that is asynchronously completed
     * by a task running in the {@link ForkJoinPool#commonPool()} with
     * the value obtained by calling the given Supplier.
     *
     * @param supplier a function returning the value to be used
     * to complete the returned CompletableFutureTest
     * @param <U> the function's return type
     * @return the new CompletableFutureTest
     */
     ...
     * returned CompletableFutureTest
     * @return the new CompletableFutureTest
     */
    ...
    /**
     * Returns a new CompletableFutureTest that is already completed with
     * the given value.
     *
     * @param value the value
     * @param <U> the type of the value
     * @return the completed CompletableFutureTest
     */
     ...
     * CompletableFutureTest threw an exception, this method throws an
     ...
     * @return {@code true} if this invocation caused this CompletableFutureTest
    ...
    /**
     * Returns this CompletableFutureTest
     *
     * @return this CompletableFutureTest
     */
    ...
    /**
     * Returns a new CompletableFutureTest that is completed when this
     * CompletableFutureTest completes, with the result of the given
     * function of the exception triggering this CompletableFutureTest's
     * completion when it completes exceptionally; otherwise, if this
     * CompletableFutureTest completes normally, then the returned
     * CompletableFutureTest also completes normally with the same value.
     * Note: More flexible versions of this functionality are
     * available using methods {@code whenComplete} and {@code handle}.
     *
     * @param fn the function to use to compute the value of the
     * returned CompletableFutureTest if this CompletableFutureTest completed
     * exceptionally
     * @return the new CompletableFutureTest
     */
    ...
    /**
     * Returns a new CompletableFutureTest that is completed when all of
     * the given CompletableFutures complete.  If any of the given
     * CompletableFutures complete exceptionally, then the returned
     * CompletableFutureTest also does so, with a CompletionException
     * holding this exception as its cause.  Otherwise, the results,
     * if any, of the given CompletableFutures are not reflected in
     * the returned CompletableFutureTest, but may be obtained by
     * inspecting them individually. If no CompletableFutures are
     * provided, returns a CompletableFutureTest completed with the value
     * {@code null}.
     *
     * <p>Among the applications of this method is to await completion
     * of a set of independent CompletableFutures before continuing a
     * program, as in: {@code CompletableFutureTest.allOf(c1, c2,
     * c3).join();}.
     *
     * @param cfs the CompletableFutures
     * @return a new CompletableFutureTest that is completed when all of the
    ...
    /**
     * Returns a new CompletableFutureTest that is completed when any of
     * the given CompletableFutures complete, with the same result.
     * Otherwise, if it completed exceptionally, the returned
     * CompletableFutureTest also does so, with a CompletionException
     * holding this exception as its cause.  If no CompletableFutures
     * are provided, returns an incomplete CompletableFutureTest.
     *
     * @param cfs the CompletableFutures
     * @return a new CompletableFutureTest that is completed with the
    ...
    /**
     * If not already completed, completes this CompletableFutureTest with
    ...
    /**
     * Returns {@code true} if this CompletableFutureTest was cancelled
     * before it completed normally.
     *
     * @return {@code true} if this CompletableFutureTest was cancelled
     * before it completed normally
     */
    ...
    /**
     * Returns {@code true} if this CompletableFutureTest completed
     * exceptionally, in any way. Possible causes include
     * cancellation, explicit invocation of {@code
     * completeExceptionally}, and abrupt termination of a
     * CompletionStage action.
     *
     * @return {@code true} if this CompletableFutureTest completed
     * exceptionally
     */
     ...
     * completions are awaiting completion of this CompletableFutureTest.
    ...
    /**
     * Returns a string identifying this CompletableFutureTest, as well as
     ...
     *
     * @return a string identifying this CompletableFutureTest, as well as its state
     */
