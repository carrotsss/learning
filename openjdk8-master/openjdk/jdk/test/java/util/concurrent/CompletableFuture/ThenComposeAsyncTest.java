 ...
 * @summary Test that CompletableFutureTest.thenCompose works correctly if the
...
public class ThenComposeAsyncTest {
    ...
    public void testThenComposeAsync() throws Exception {
        // Composing CompletableFutureTest is complete
        CompletableFuture<String> cf1 = CompletableFuture.completedFuture("one");

        // Composing function returns a CompletableFutureTest executed asynchronously
        ...
        // Ensure returned CompletableFutureTest completes after call to thenCompose
