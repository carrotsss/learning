...
//		System.out.println(Class.forName("cn.bcw_04_reflect.City").isEnum());
//
//		//判断当前的Class对象表示是否是接口
//		System.out.println(personClass.isInterface());
//		System.out.println(Class.forName("cn.bcw_04_reflect.TestInterface").isInterface());
//
//
//	}
//
