...
public class FutureAdapter<V> extends CompletableFuture<V> {
     ...
     * Mostly user use RpcContext.getFuture() to refer the instance of this class, so the user will get a CompletableFutureTest, this method will rarely be noticed.
     *
     * @return
     */
