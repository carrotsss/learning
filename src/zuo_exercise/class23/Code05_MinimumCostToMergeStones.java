...
//	public static int f(int[] arr, int K, int L, int R, int P746_MinCostClimbingStairs) {
//		if(从L到R根本不可能弄出P份) {
//			return Integer.MAX_VALUE;
//		}
//		// 真的有可能的！
//		if(P746_MinCostClimbingStairs == 1) {
//			return L == R ? 0 : (f(arr, K, L, R, K) + 最后一次大合并的代价);
//		}
//		int ans = Integer.MAX_VALUE;
//		// 真的有可能，P746_MinCostClimbingStairs > 1
//		for(int i = L; i < R;i++) {
//			// L..i(1份)  i+1...R(P746_MinCostClimbingStairs-1份)
//			int left = f(arr, K, L, i, 1);
//			if(left == Integer.MAX_VALUE) {
//				continue;
//			}
//			int right = f(arr, K, i+1,R,P746_MinCostClimbingStairs-1);
...
//	}
	...
	public static int process1(int L, int R, int P, int[] arr, int K, int[] presum) {
		...
		} else { // P746_MinCostClimbingStairs > 1
			int ans = Integer.MAX_VALUE;
