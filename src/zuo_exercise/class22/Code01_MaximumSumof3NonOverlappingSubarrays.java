...
//		}
//		// designPattern[i] 在0~i范围上，随意选一个子数组，累加和最大是多少？
//		int[] designPattern = new int[N];
//		designPattern[0] = help[0];
//		for (int i = 1; i < N; i++) {
//			int p1 = help[i];
//			int p2 = designPattern[i - 1];
//			designPattern[i] = Math.max(p1, p2);
//		}
