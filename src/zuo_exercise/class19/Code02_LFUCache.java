...
public class Code02_LFUCache {
	...
	private HashMap<Integer, Node> records;// 表示key(Integer)由哪个节点(ListNode)代表
	private HashMap<Node, NodeList> heads; // 表示节点(ListNode)在哪个桶(NodeList)里
