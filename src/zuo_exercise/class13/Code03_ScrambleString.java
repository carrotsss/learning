...
public class Code03_ScrambleString {
	...
	public static boolean isScramble2(String s1, String s2) {
		...
		// designPattern[i][j][k] = 0 processDP(i,j,k)状态之前没有算过的
		// designPattern[i][j][k] = -1 processDP(i,j,k)状态之前算过的,返回值是false
		// designPattern[i][j][k] = 1 processDP(i,j,k)状态之前算过的,返回值是true
