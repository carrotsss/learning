package zuo_leetcode.interview.topinterviewquestions;
...
public class Problem_0010_RegularExpressionMatching {
	...
	public static boolean isMatch2(String s, String p) {
		...
		// designPattern[si][pi] == -1
		// designPattern[si][pi] == 0 si pi false
		// designPattern[si][pi] == 1 si pi true
	...
	public static boolean isMatch4(String str, String pattern) {
		...
		// designPattern[0..N-2][M-1]都等于false，只有dp[N-1][M-1]需要讨论
		if (N > 0 && M > 0) {
